...
bool IsSehat(Vital v){
    return (v.tekananDarah >= 90 && v.tekananDarah <= 140 && v.detakJantung >= 60 && v.detakJantung <= 100 && v.saturasiOksigen >= 95.0);
}
/* True jika:
...
int CompareVital(Vital a, Vital b){
    if ((a.detakJantung + a.saturasiOksigen + a.tekananDarah) < (b.detakJantung + b.saturasiOksigen + b.tekananDarah)){
        return -1;
    }
    else if ((a.detakJantung + a.saturasiOksigen + a.tekananDarah) == (b.detakJantung + b.saturasiOksigen + b.tekananDarah)){
        return 0;
    }
    else if ((a.detakJantung + a.saturasiOksigen + a.tekananDarah) > (b.detakJantung + b.saturasiOksigen + b.tekananDarah)){
        return 1;
