...
isKabisat :: Int -> Bool
isKabisat year = (mod year 400 == 0) || ((mod year 4 == 0) && (mod year 100 /= 0))
...
hariDalamBulan b t
    ...
    | (b == 4 || b == 6 || b == 9 || b == 11) = 30
    | (b == 2) = if (isKabisat t) then 29 else 28
...
isValid tanggal =
    let
        ...
        year = tahun tanggal
    in
        year >= 1 && month >= 1 && month <= 12 && day >= 1 && day <= hariDalamBulan month year
