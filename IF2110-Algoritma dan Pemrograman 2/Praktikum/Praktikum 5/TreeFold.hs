...
treeFoldPost f b t
  | isTreeEmpty t = b
  | otherwise
  = f (treeFoldPost f b (left t)) (treeFoldPost f b (right t)) (akar t)
...
treeFoldPre f b t
  | isTreeEmpty t = b
  | otherwise
  = f (akar t) (treeFoldPre f b (left t)) (treeFoldPre f b (right t))
...
treeFoldIn f b t
  | isTreeEmpty t = b
  | otherwise
  = f  (treeFoldIn f b (left t)) (akar t) (treeFoldIn f b (right t))
